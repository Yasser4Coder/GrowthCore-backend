...
import {
  salesHistogram,
  salesOverTimeHistogram,
} from "../controllers/histogramController.js";

const router = exporess.Router();

router.get("/sales/:csvId", salesHistogram);
router.get("/sales-over-time/:csvId", salesOverTimeHistogram);
...
/**
 * @swagger
 * api/histograms/sales-over-time/{csvId}:
 *   get:
 *     summary: Get sales histogram data
 *     tags: [line graph]
 *     description: Fetches sales histogram data for a given CSV file ID.
